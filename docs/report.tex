...
\titleformat{\section}
  {\normalfont\Large\bfseries\clearpage}  % <-- page break added here
  {HW \#\arabic{section}}
  {1em}
  {}
...
To see full image click on \verb|parking-er-diagram.png|
\begin{center}
\includegraphics[width=\textwidth, keepaspectratio]{parking-er-diagram.png}
\end{center}
