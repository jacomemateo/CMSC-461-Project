...
Here \inlinecode{parking\_type}, \inlinecode{lot\_type}, \inlinecode{permit\_type} and \inlinecode{event\_type} are all SQL enum types. I have defined them in \inlinecode{db/migrations/01\_enums.sql}
...
\subsection{Normalization Disucssion}
